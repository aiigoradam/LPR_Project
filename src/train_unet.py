    ...
    with mlflow.start_run(run_name=config['run_name']):
        ...
        try:
            ...
            for epoch in range(num_epochs):
                ...
                # Save the best model if either val_loss improves OR val_ssim improves
                if (val_loss < best_val_loss) or (val_ssim > best_val_ssim):
            ...
            print("\nTraining interrupted. Saving the current best model...")
